...
FIELD_SELECTORS = {
    "Date": "input[id*='date']",                    # More flexible
    "Company": "input[id*='company.name']",
    "Role": "input[id*='job-title']",
    "URL": "input[id*='online-form-url']",
    "Type": "label[for='alv-checkbox-portal.work-efforts.edit-form.apply-channel.electronic-0']",
    ...
    "PLZ Ort": "input[id='alv-single-typeahead-plz-/-ort-0']",
    # Add more as needed
}
